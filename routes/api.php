...
Route::group(['prefix' => 'payment'] ,function(){
    //mpesa callback urls
    // Route::get('/register-url', 'Api\v1\mpesa\MpesaController@c2bRegisterUrls');
    // Route::post('/pay', 'Api\v1\mpesa\MpesaController@simulateC2B');

    // Route::any('/validate', 'Api\v1\mpesa\CallbackController@validateTransaction');
    // Route::any('/confirm', 'Api\v1\mpesa\CallbackController@confirmTransaction');
